        ...
        <div className="w-full h-40 flex justify-center items-center">
          <div className="flex gap-2">
            <input
              ...
              className="w-96 h-10 border-2 rounded-md bg-slate-100 border-gray-200 outline-none p-2"
            />
            <button
              onClick={handleSubmit}
              className="w-10 h-10 bg-navlight rounded-md flex justify-center items-center"
            >
              <svg
