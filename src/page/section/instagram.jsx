...
export default function Instagram({theme, handleToggle}) {
  ...
  const categories = {
    "followers": [
      {"name": "Followers Instagram", "value": 100, "price": 10000, "icon": <Ig className={`${theme === 'light' ? 'fill-navlight' : 'fill-navdark'} w-16 h-16`}/>},
      {"name": "Followers Instagram", "value": 300, "price": 10000, "icon": <Ig className={`${theme === 'light' ? 'fill-navlight' : 'fill-navdark'} w-16 h-16`}/>},
      {"name": "Followers Instagram", "value": 500, "price": 10000, "icon": <Ig className={`${theme === 'light' ? 'fill-navlight' : 'fill-navdark'} w-16 h-16`}/>},
      {"name": "Followers Instagram", "value": 1000, "price": 10000, "icon": <Ig className={`${theme === 'light' ? 'fill-navlight' : 'fill-navdark'} w-16 h-16`}/>},
    ],
    "likes": [
